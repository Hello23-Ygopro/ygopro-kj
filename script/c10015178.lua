...
scard.tg1=aux.CheckCardFunction(scard.retfilter,LOCATION_BZONE,0)
function scard.op1(e,tp,eg,ep,ev,re,r,rp)
	local ct=Duel.GetMatchingGroupCount(scard.retfilter,tp,LOCATION_BZONE,0,nil)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g=Duel.SelectMatchingCard(tp,scard.retfilter,tp,LOCATION_BZONE,0,1,ct,nil)
